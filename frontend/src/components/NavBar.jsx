...
function NavBar() {
    ...
    return (
        <>
            <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 right-0 left-0 z-30 dark:bg-slate-900 ${sticky ? 'bg-base-200 sticky-navbar shadow-md duration-300 transitionn-all ease-in-out dark:bg-slate-600' : ''
                }`}>
                    ...
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className='hidden md:block'>
                            <label className="px-3 py-2 border rounded-md flex items-center gap-2 ">
                                <input type="text" className="bg-transparent grow outline-none dark:text-white dark:bg-slate-900" placeholder="Search" />
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
