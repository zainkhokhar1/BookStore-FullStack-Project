                ...
                <div className="modal-box border shadow-lg">
                    <form method="dialog" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className='mt-4 space-y-2'>
                            <span>Name</span> <br />
                            <input type="text" placeholder='Enter your Name fullName' className='py-2 px-3 rounded-md outline-none border w-80 ' {...register("name", { required: true })} />
                            <br />
                        ...
                        <div className='mt-4 space-y-2'>
                            ...
                            <input type="password" placeholder='Enter your Password' className='py-2 px-3 rounded-md outline-none border w-80 ' {...register("password", { required: true, minLength: 5 })} />
                            <br />
